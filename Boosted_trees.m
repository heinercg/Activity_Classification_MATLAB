...
% Auto-generated by MATLAB on 03-Jul-2025 18:21:58
...
predictorNames = {'Frontal', 'Vertical', 'Lateral', 'Gender'};
predictors = inputTable(:, predictorNames);
response = inputTable.Activity;
isCategoricalPredictor = [false, false, false, true];
classNames = categorical({'Amb'; 'Ly'; 'SB'; 'SC'});
...
trainedClassifier.RequiredVariables = {'Frontal', 'Gender', 'Lateral', 'Vertical'};
